...
public class SlotMachineGUI
{
    ...
    public void genReelNumbers()
    {
        ...
        { // If the Always win cheat mode is enabled.
            int winType = rand.nextInt(4); // generates number between 0-3 to determine the type of win
            reel1 = rand.nextInt(images.size());
            if (winType == 0)
            { // winType = 0 - Reels 1, 2 and 3 will all match.
                reel2 = reel1;
                reel3 = reel1;
            }
            else if (winType == 1)
            { // winType = 1 - Reels 1 and 2 will match.
                reel2 = reel1;
            }
            else if (winType == 2)
            { // winType = 2 - Reels 1 and 3 will match.
                reel3 = reel1;
            }
            else
    ...
    public void prgBarCheck()
    {
        ...
        else if (prgbarCheatUnlocker.getValue() == 100)
        { // after 100 wins unlock the cheats.
